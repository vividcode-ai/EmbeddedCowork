export const instanceMessages = {
  ...
  "instanceShell.gitChanges.commit.submit": "Зафиксировать",
  ...
  "instanceShell.gitChanges.noSessionSelected": "Выберите сессию для просмотра Git-изменений.",
  "instanceShell.filesShell.hideFiles": "Скрыть файлы",
  "instanceShell.filesShell.showFiles": "Показать файлы",
  "instanceShell.diff.hideUnchanged": "Скрыть неизменённые области",
  "instanceShell.diff.showFull": "Показать весь файл",
  "instanceShell.diff.switchToSplit": "Переключиться на раздельный вид",
  "instanceShell.diff.switchToUnified": "Переключиться на единый вид",
