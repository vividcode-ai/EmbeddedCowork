export const appMessages = {
  ...
  "emptyState.logoAlt": "EmbeddedCowork ロゴ",
  ...
  "releases.upgradeRequired.message.withVersion": "最新の UI を使うには EmbeddedCowork {version} に更新してください。",
  "releases.upgradeRequired.message.noVersion": "最新の UI を使うには EmbeddedCowork を更新してください。",
