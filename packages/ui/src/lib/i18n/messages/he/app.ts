export const appMessages = {
  ...
  "emptyState.logoAlt": "לוגו EmbeddedCowork",
  ...
  "releases.upgradeRequired.message.withVersion": "שדרג ל-EmbeddedCowork {version} כדי להשתמש בממשק המעודכן.",
  "releases.upgradeRequired.message.noVersion": "שדרג את EmbeddedCowork כדי להשתמש בממשק המעודכן.",
