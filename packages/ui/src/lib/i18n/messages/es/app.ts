export const appMessages = {
  ...
  "emptyState.logoAlt": "Logo de EmbeddedCowork",
  ...
  "releases.upgradeRequired.message.withVersion": "Actualiza a EmbeddedCowork {version} para usar la UI más reciente.",
  "releases.upgradeRequired.message.noVersion": "Actualiza EmbeddedCowork para usar la UI más reciente.",
  ...
  "update.ready.action": "Actualización silenciosa en segundo plano",
} as const
