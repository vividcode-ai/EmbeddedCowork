export const settingsMessages = {
  ...
  "statusTab.contextToken": "Context Token",
  "statusTab.sessionToken": "Session Total",
  ...
  "settings.appearance.language.subtitle": "Choose the display language for the app interface.",
  "settings.appearance.language.select": "Display language",
