export const messagingMessages = {
  ...
  "messageSection.scroll.enableHoldAriaLabel": "启用长AI回复保持",
  "messageSection.scroll.disableHoldAriaLabel": "禁用长AI回复保持",
  ...
  "messageTimeline.tooltip.assistantFallback": "AI回复",
  ...
  "messageItem.speaker.assistant": "AI",
  ...
  "promptInput.conversationMode.error.message": "无法继续播报AI回复。",
