...
```bash
npm run build --workspace @neuralnomads/embedcowork-electron-app
```
...
1. **Build @neuralnomads/embedcowork** → Produces the CLI `dist/` bundle (also rebuilds the UI assets it serves)
